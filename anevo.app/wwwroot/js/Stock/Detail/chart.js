...
function GetCurrentPrice(days) {
    $.ajax({
        url: "https://api.allinoneapi.app/api/Stock/GetPrice?symbol=" + ticker,
...
function appendData2(time_count, interval, lines) {
    ...
    filename2 = "https://api.allinoneapi.app/api/Stock/GetKandles?symbol=" + ticker +"&interval=" + interval2 + "&minutes=" + time_count2 + "&lines=5000&datestart=" + date_start + "&dateend=" + date_end;
